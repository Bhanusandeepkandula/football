...
const styles = StyleSheet.create({
  ...
  formationText: { color: 'rgba(255,255,255,0.6)', fontSize: 10, fontFamily: 'Inter_500Medium' },
  ...
  jerseyNum: { color: '#fff', fontFamily: 'Inter_700Bold' },
  playerName: {
    color: '#fff', fontSize: 9, fontFamily: 'Inter_600SemiBold',
