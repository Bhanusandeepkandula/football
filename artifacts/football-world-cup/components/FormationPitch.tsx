...
function PlayerDot({ player, color, size = 36 }: PlayerDotProps) {
  ...
  return (
    <View style={styles.playerWrapper}>
      <View style={[styles.playerDot, { width: size, height: size, borderRadius: size / 2, backgroundColor: bgColor }]}>
        <Text style={[styles.jerseyNum, { fontSize: size * 0.33 }]}>{player.jersey || player.positionGroup[0]}</Text>
      </View>
...
function PlayerRow({ players, color }: RowProps) {
...
export function FormationPitch({ home, away }: FormationPitchProps) {
...
const MARKING_COLOR = 'rgba(255,255,255,0.25)';
